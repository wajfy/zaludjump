...
class Zalud(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        zalud_walk1 = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/zalud1.png").convert_alpha()
        zalud_walk2 = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/zalud2.png").convert_alpha()
        self.zalud_walk = [zalud_walk1, zalud_walk2]
        self.zalud_index = 0
        self.zalud_jump = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/zalud_jump.png").convert_alpha()
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == "dollar": 
           self.image = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/dollar_p.png").convert_alpha()
...
die_sound = pygame.mixer.Sound("C:/Users/Jakub/PycharmProjects/pygame 1/assets/die.mp3")
bg_music = pygame.mixer.Sound("C:/Users/Jakub/PycharmProjects/pygame 1/assets/bg_music.mp3")
...
background_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/background.png").convert_alpha()

sky_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/sky.png").convert() #vložení surface
sky_surface2 = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/sky.png").convert()

shadow_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/shadow.png").convert_alpha()
ground_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/ground.png").convert()
ground_surface2 = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/ground.png").convert()

text_font = pygame.font.Font("C:/Users/Jakub/PycharmProjects/pygame 1/assets/Pixellari.ttf",75)
text_surface = text_font.render("Žalud Jump", None, "White")
text_surface_outline = text_font.render("Žalud Jump", None, "#1f1f1f")

score_font = pygame.font.Font("C:/Users/Jakub/PycharmProjects/pygame 1/assets/Pixellari.ttf",50)
...
created_by_font = pygame.font.Font("C:/Users/Jakub/PycharmProjects/pygame 1/assets/Pixellari.ttf",30)
...
dollar_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/dollar_p.png").convert_alpha()
dollar_surface_rectangle = dollar_surface.get_rect (center = (dollar_x, dollar_y))

obstacle_rect_list = []

zalud_shadow_surface = pygame.image.load("C:/Users/Jakub/PycharmProjects/pygame 1/assets/dollar_shadow.png").convert_alpha()
